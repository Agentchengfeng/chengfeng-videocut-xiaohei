...
- User-specified canvas dimensions/aspect ratio take priority; 16:9 horizontal is only the default when no choice is specified. Adapt composition and viewBox in the output copy, keeping character proportions intact.
